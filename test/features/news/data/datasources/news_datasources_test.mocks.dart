...
// in newsify_demo/test/features/news/data/datasources/news_datasources_test.dart.
...
import 'package:newsify_demo/core/network/api_client.dart' as _i4;
...
class MockApiClient extends _i1.Mock implements _i4.ApiClient {
  ...
  @override
  _i5.Future<_i2.RetryClient> getApiClient() =>
      (super.noSuchMethod(Invocation.method(#getApiClient, []),
              returnValue: Future<_i2.RetryClient>.value(_FakeRetryClient_0()))
          as _i5.Future<_i2.RetryClient>);
}

/// A class which mocks [RetryClient].
///
/// See the documentation for Mockito's code generation for more information.
class MockRetryClient extends _i1.Mock implements _i2.RetryClient {
  MockRetryClient() {
    _i1.throwOnMissingStub(this);
  }
